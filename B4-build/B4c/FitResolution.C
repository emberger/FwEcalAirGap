...
std::string filename="EnergyResolution_Titan.C";

std::string savepath=folder+filename;

c2->Print(savepath.c_str());

filename="EnergyResolution_Titan.pdf";
...
std::string filename="EnergyResolution_Steel.C";

std::string savepath=folder+filename;

c2->Print(savepath.c_str());

filename="EnergyResolution_Steel.pdf";
