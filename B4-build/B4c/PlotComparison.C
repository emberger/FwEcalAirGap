{
        ...
        //
        // TFile * f4= new TFile("~/Geant4/Data/ForwardEcalWithAirGap/AngularResolution_OutlierRejection/AngReso_IT20_OT20_Ogapfirst_30Inner_50Outer_lead1mm_Polystyrene5mm_20mmSteelVessel_noDigitizing/EnergyResolution.root");
 ...
 */
        ...
        // TFile * f5= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead1mm_Polystyrene5mm_20mmSteelVessel/EnergyResolution.root");
        // TCanvas * c5=(TCanvas*)f5->Get("c2p");
        // TGraph * g5=(TGraph*)c5->GetListOfPrimitives()->At(1);
        //
        //
        // TFile * f6= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead2mm_Polystyrene5mm_20mmSteelVessel/EnergyResolution.root");
        // TCanvas * c6=(TCanvas*)f6->Get("c2p");
        // TGraph * g6=(TGraph*)c6->GetListOfPrimitives()->At(1);
        //
...
//Standard is 1cm Lead, NO Vessel
        ...
        for(Int_t i=0; i < nofPoints; i++) {
                ...
                Double_t stax,stay;
                g2->GetPoint(i, stax, stay);        //reference geometry
        ...
        // l1->AddEntry(rat5, "25innerLayer_1mmLeadAbsorber_20mmSteelVessel", "p");
        // l1->AddEntry(rat6, "25innerLayer_2mmLeadAbsorber_20mmSteelVessel", "p");
        ...
        // l2->AddEntry(g5, "25innerLayers_1mmLeadAbsorber_20mmSteelVessel", "p");
        // l2->AddEntry(g6, "25innerLayers_2mmLeadAbsorber_20mmSteelVessel", "p");
        ...
        g1->GetYaxis()->SetRangeUser(0.0,0.65);
