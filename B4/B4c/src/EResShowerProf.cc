...
void EResShowerProf::EResAndProfile(Double_t cut, std::string pth){
        ...
        for(Int_t i=0; i<10; i++) {
                ...
                fileName=pth+"/gamma"+std::to_string(Estart)+"MeV_0.0:0.0_.root";
        ...
        //
        //}
        //eres[5]=(edepdistribution->GetRMS(1)/edepdistribution->GetMean());
        ...
        std::unique_ptr<TGraph> Eres(new TGraph(5, x, eres));
        ...
        Eres->Draw("ap");
        std::string path=pth+"/EnergyResolution.C";
